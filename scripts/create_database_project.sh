...
#bee api github.com/juusechec/oas_be_cancelacion_semestre -driver=postgres -conn=postgres://cancelacion_semestre:docker@localhost:5432/udistrital?sslmode=disable&search_path=cancelacion_semestre
